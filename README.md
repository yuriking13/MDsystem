...
- `apps/web/tests/config/responsiveManualMatrix.json` must remain a valid manual QA matrix config with canonical viewport/route lists and valid fixed-route regex patterns.
