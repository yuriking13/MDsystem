...
class TableManager {
        ...
        this.taskTable = new Tabulator("#task-queue-table", {
            ...
            columns: [
                ...
                },
                {
                    ...
                    formatter: function(cell) {
                        const value = cell.getValue();
                        return value ? `<span style="color: #63b3ed;">${value}</span>` : '-';
                    }
                },
                {
                    title: "Created",
                ...
                },
                {
                    ...
                    formatter: function(cell) {
                        ...
                        if (row.status === 'failed') {
                            buttons.push('<button class="btn btn-sm retry-btn" title="Retry">↻</button>');
                        }
                        if (row.status === 'processing') {
                            buttons.push('<button class="btn btn-sm cancel-btn" title="Cancel">✕</button>');
                        }
                        buttons.push('<button class="btn btn-sm view-btn" title="View Details">👁</button>');
            ...
            columns: [
                ...
                },
                {
                    ...
                    formatter: function(cell) {
                        ...
                        return value > 1 ? `<span style="color: #ed8936; font-weight: 600;">${value}</span>` : value;
                    }
                },
                {
                    title: "Actions",
        ...
        this.agentTable = new Tabulator("#agent-status-table", {
            ...
            columns: [
                ...
                },
                {
                    ...
                    formatter: function(cell) {
                        const value = cell.getValue() || 0;
                        return value > 0 ? `<span style="color: #ed8936; font-weight: 600;">${value}</span>` : value;
                    }
                },
                {
                    title: "CPU",
                    ...
                    formatter: function(cell) {
                        const value = cell.getValue() || 0;
                        const color = value > 80 ? '#f56565' : value > 60 ? '#ed8936' : '#48bb78';
                ...
                },
                {
                    ...
                    width: 120,
                    formatter: function() {
                        return '<button class="btn btn-sm restart-btn" title="Restart Agent">↻</button> ' +
    ...
    addError(error) {
        if (this.errorTable) {
            ...
            const similar = existingData.find(e => 
                e.level === error.level && 
