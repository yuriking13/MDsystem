...
export default function TiptapToolbar({ 
  ...
  return (
    <div className="tiptap-toolbar">
      ...
      {onImportFile && (
        <button 
          style={{...btnWide('rgba(168,85,247,0.3)', '#a855f7'), display: 'flex', alignItems: 'center'}} 
          onClick={onImportFile}
          title="Вставить файл из проекта"
        >
          <svg style={{ width: 12, height: 12, marginRight: 4 }} fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
      ...
      {onToggleReviewMode && (
        <button 
          style={{
            ...btnWide(reviewMode ? 'rgba(251, 191, 36, 0.3)' : 'rgba(100, 116, 139, 0.2)', reviewMode ? '#fbbf24' : '#94a3b8'),
            display: 'flex',
            alignItems: 'center',
          }}
          onClick={onToggleReviewMode}
          title={reviewMode ? 'Отключить режим рецензирования' : 'Включить режим рецензирования'}
        >
          <svg width={12} height={12} fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
