...
function CitationItem({
  ...
  return (
    <div className="p-3 hover:bg-neutral-50 dark:hover:bg-neutral-800/50 transition-colors group">
        ...
        <div className="pl-10 pr-3 pb-3 space-y-2">
          {citationInfos.map((info) => {
            ...
            return (
              <div
                key={citation.id}
                className="flex items-start gap-2 p-2 bg-neutral-50 dark:bg-neutral-800/50 rounded"
              >
                <button
