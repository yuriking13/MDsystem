...
export default function AdminSettingsPage() {
  ...
  async function handleGenerateToken() {
    ...
    try {
      ...
      alert(err?.message || "Ошибка генерации токена");
    } finally {
      setGenerating(false);
    }
  }
          ...
          <div className="admin-card">
            ...
            <div className="admin-card-content">
              <p className="admin-settings-description">
                Сгенерируйте специальный токен для дополнительной защиты входа в админ-панель.
                После генерации токен будет требоваться при каждом входе.
              </p>
              ...
              <div className="admin-settings-note">
                <strong>Примечание:</strong> Если вы потеряете токен, вам нужно будет
                сгенерировать новый. Старый токен перестанет работать.
              </div>
            </div>
          </div>
          ...
          <div className="admin-card">
            ...
            <div className="admin-card-content">
              <p className="admin-settings-description">
                ...
                проектов пользователей для защиты их интеллектуальной собственности.
              </p>
