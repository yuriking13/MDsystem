    ...
    while (currentWeek.length > 0 && currentWeek.length < 7) {
      currentWeek.push(
        <div
          ...
          className="admin-calendar-cell empty"
        />,
      );
    }
        ...
        <div className="admin-calendar-container">
          ...
          <div className="admin-calendar">
            ...
            {loading ? (
              ...
              <div className="admin-calendar-grid">{renderCalendar()}</div>
            )}
          </div>
                    ...
                    <tbody>
                      {dailyActivity.map((user) => (
                        <tr key={user.user_id}>
                          ...
                          <td>
                            {formatMinutes(
                              parseFloat(user.total_minutes || "0"),
                            )}
                          </td>
                ...
                {loading ? (
                  ...
                  activityList.map((item) => (
                    <tr key={item.id}>
                      ...
                      <td>
                        <span
                          className={`admin-badge admin-badge-${item.action_type}`}
                        >
                      ...
                      <td className="admin-table-detail">
                        {item.action_detail &&
                        typeof item.action_detail === "object"
