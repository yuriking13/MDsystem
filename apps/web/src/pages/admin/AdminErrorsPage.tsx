...
function ErrorDetailModal({ error, onClose, onResolve }: ErrorDetailModalProps) {
  ...
  return (
    <div className="admin-modal-overlay" onClick={onClose}>
      <div className="admin-modal admin-error-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="admin-modal-body">
          <div className="admin-error-detail-grid">
            <div className="admin-error-detail-item">
              ...
              <span className="admin-badge admin-badge-error">{error.error_type}</span>
            </div>
            ...
            <div className="admin-error-detail-item full-width">
              <span className="admin-error-detail-label">Сообщение об ошибке</span>
...
export default function AdminErrorsPage() {
  ...
  const [resolvedFilter, setResolvedFilter] = useState<"true" | "false" | "all">("false");
  ...
  return (
    <div className="admin-page">
        <div className="admin-page-header">
          ...
          <button className="btn secondary" onClick={loadErrors} disabled={loading}>
                  ...
                  errors.map((err) => (
                    <tr key={err.id} className={err.resolved ? "resolved" : ""}>
                      ...
                      <td className="admin-table-request mono">
                        {err.request_method} {err.request_path?.slice(0, 30) || "—"}
                      </td>
