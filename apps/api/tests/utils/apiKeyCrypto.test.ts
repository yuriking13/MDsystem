...
describe('API Key Crypto', () => {
  ...
  describe('decryptApiKey', () => {
    ...
    it('should throw on invalid format', () => {
      expect(() => decryptApiKey('invalid', KEY)).toThrow('Unsupported encrypted key format');
      expect(() => decryptApiKey('v2:abc:def:ghi', KEY)).toThrow('Unsupported encrypted key format');
    });
